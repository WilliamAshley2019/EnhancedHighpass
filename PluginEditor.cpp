...
//==============================================================================
EnhancedHighpassAudioProcessorEditor::EnhancedHighpassAudioProcessorEditor(EnhancedHighpassAudioProcessor& p)
    : AudioProcessorEditor(&p), processorRef(p)
{
    ...
    cutoffLabel.setFont(juce::Font(juce::FontOptions{ 14.0f }));
    ...
    qLabel.setFont(juce::Font(juce::FontOptions{ 14.0f }));
    ...
    wetDryLabel.setFont(juce::Font(juce::FontOptions{ 14.0f }));
    ...
    setSize(500, 350); // Matches EnhancedLowpass
}

EnhancedHighpassAudioProcessorEditor::~EnhancedHighpassAudioProcessorEditor() {}

//==============================================================================
void EnhancedHighpassAudioProcessorEditor::paint(juce::Graphics& g)
{
    g.fillAll(juce::Colours::darkslategrey);

    g.setColour(juce::Colours::white);
    g.setFont(juce::Font(juce::FontOptions{ 18.0f }));
    g.drawFittedText("Enhanced Highpass", getLocalBounds().removeFromTop(30),
        juce::Justification::centred, 1);
}

void EnhancedHighpassAudioProcessorEditor::resized()
{
