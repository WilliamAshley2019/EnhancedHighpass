...
class EnhancedHighpassAudioProcessor : public juce::AudioProcessor
{
public:
    EnhancedHighpassAudioProcessor();
    ~EnhancedHighpassAudioProcessor() override;
...
private:
    ...
    float currentSampleRate = 44100.0f; // Explicit float to avoid C4244
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(EnhancedHighpassAudioProcessor)
};